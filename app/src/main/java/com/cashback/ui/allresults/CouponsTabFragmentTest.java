...
public class CouponsTabFragmentTest extends Fragment {
    private FragmentUi fragmentUi;

    public static CouponsTabFragmentTest newInstance() {
        return new CouponsTabFragmentTest();
    }

    public CouponsTabFragmentTest() {
    }
    ...
    public class FragmentUi {
        ...
        public FragmentUi(CouponsTabFragmentTest fragment, View view) {
