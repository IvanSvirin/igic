...
public class ProductsTabFragmentTest extends Fragment {
    private FragmentUi fragmentUi;

    public static ProductsTabFragmentTest newInstance() {
        return new ProductsTabFragmentTest();
    }

    public ProductsTabFragmentTest() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (display.getRotation() == Surface.ROTATION_90 || display.getRotation() == Surface.ROTATION_270) {
            view = inflater.inflate(R.layout.layout_featured_tab_new1_land, container, false);
        } else {
            view = inflater.inflate(R.layout.layout_featured_tab_new1, container, false);
        }
    ...
    public class FragmentUi {
        ...
        public FragmentUi(ProductsTabFragmentTest fragment, View view) {
    ...
    public static class ProductsRecyclerAdapter extends RecyclerView.Adapter<ProductsRecyclerAdapter.ProductsViewHolder> {
        ...
        public ProductsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (parent instanceof RecyclerView) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_common_product, parent, false);
